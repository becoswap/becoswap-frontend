...
export const BECO_PER_BLOCK = new BigNumber(40)
export const BLOCKS_PER_YEAR = new BigNumber((60 / BSC_BLOCK_TIME) * 60 * 24 * 365) // 10512000
export const BASE_URL = 'https://becoswap.finance'
export const BASE_EXCHANGE_URL = 'https://exchange.becoswap.finance'
